  ...
  render() {
    ...
    const snackbar = (
      <Snackbar
        ...
        message={<span id="message-id">Configuración Actualizada </span>}
      />
    )
    ...
    return (
      <Grid
        ...
        justify="center"
        alignItems="center"
        className={classNames(scss['portal-profile'], classes.background)}
      >
              ...
              <Grid container direction="row" spacing={0} justify="center" alignItems="center">
                <Grid item xs={12}>
                  <div className={scss['portal-profile__header']}>
                    <img
                      alt="avatar"
                      src="assets/images/avatars/female/33.jpg"
                      className={scss['portal-profile__header-avatar']}
                    />
                    <div>
                      <Typography variant="h5" gutterBottom>
                        Perfil de Usuario / Maira Daniela Ferrari
                      </Typography>
                      <Typography variant="subtitle1" gutterBottom>
                        Edite su información personal, cambie su password y configuración de
                        privacidad.
                      </Typography>
                    </div>
                  </div>
